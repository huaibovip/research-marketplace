...
```bash
# claude / copilot
/plugin marketplace add huaibovip/research-marketplace

# codex
codex plugin marketplace add huaibovip/research-marketplace
```
...
```bash
# claude / copilot (ssh)
/plugin marketplace add git@github.com:huaibovip/research-marketplace.git

# codex (ssh)
codex plugin marketplace add git@github.com:huaibovip/research-marketplace.git
```
